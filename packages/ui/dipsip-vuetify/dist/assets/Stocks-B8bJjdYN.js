import{a5 as Yn,a6 as nt,a7 as Jn,a8 as hs,a9 as fs,aa as Xn,ab as yt,ac as _,ad as He,ae as ps,af as cn,ag as zt,ah as ms,s as Qn,_ as ht,E as M,A as Nt,C as qe,z as Zn,ai as ln,M as qt,aj as er,q as ft,ak as gs,al as _s,I as vs,am as ys,an as Is,H as ks,ao as bs,ap as Es,aq as Ts,J as ws,ar as Ss,as as Cs,L as As,at as Ds,P as Os,G as Ns,x as It,y as _e,p as Ps,o as Rs,D as xs,w as Ls}from"./index-qidaSccv.js";import{N as ve,O as Ne,P as I,Q as w,_ as Pt,$ as Rt,m as h,S as Ms,R as kt,c as C,d as xt,s as Ke,w as tr,a as nr,n as U,z as Us,A as Vs,E as rr,F as Fs,V as bt}from"./vue-BQEgaIvT.js";import{A as Bs}from"./apexcharts-3z0-31-X.js";import{a as $s,M as js,V as Hs}from"./VAutocomplete-C1TCW05R.js";import{p as J,J as Ye,g as ie,f as me,Z as Ws,aJ as Me,B as de,G as Je,aK as Gs,ax as sr,o as ir,ak as zs,T as qs,m as Ks,b as Ys,d as Js,a0 as rt,W as Xs}from"./vuetify-BbdkIOBN.js";import{V as Qs}from"./VSnackbar-CaqblNDM.js";import"./VDialog-DyO7FhE3.js";function Zs(t){return typeof t=="object"&&t!==null}function ei(t,e){if(!!!t)throw new Error("Unexpected invariant triggered.")}const ti=/\r\n|[\n\r]/g;function Lt(t,e){let n=0,s=1;for(const r of t.body.matchAll(ti)){if(typeof r.index=="number"||ei(!1),r.index>=e)break;n=r.index+r[0].length,s+=1}return{line:s,column:e+1-n}}function ni(t){return ar(t.source,Lt(t.source,t.start))}function ar(t,e){const n=t.locationOffset.column-1,s="".padStart(n)+t.body,r=e.line-1,i=t.locationOffset.line-1,a=e.line+i,c=e.line===1?n:0,o=e.column+c,l=`${t.name}:${a}:${o}
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const K=new yr("@firebase/app"),va="@firebase/app-compat",ya="@firebase/analytics-compat",Ia="@firebase/analytics",ka="@firebase/app-check-compat",ba="@firebase/app-check",Ea="@firebase/auth",Ta="@firebase/auth-compat",wa="@firebase/database",Sa="@firebase/data-connect",Ca="@firebase/database-compat",Aa="@firebase/functions",Da="@firebase/functions-compat",Oa="@firebase/installations",Na="@firebase/installations-compat",Pa="@firebase/messaging",Ra="@firebase/messaging-compat",xa="@firebase/performance",La="@firebase/performance-compat",Ma="@firebase/remote-config",Ua="@firebase/remote-config-compat",Va="@firebase/storage",Fa="@firebase/storage-compat",Ba="@firebase/firestore",$a="@firebase/vertexai",ja="@firebase/firestore-compat",Ha="firebase",Wa="11.1.0";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const $t="[DEFAULT]",Ga={[Bt]:"fire-core",[va]:"fire-core-compat",[Ia]:"fire-analytics",[ya]:"fire-analytics-compat",[ba]:"fire-app-check",[ka]:"fire-app-check-compat",[Ea]:"fire-auth",[Ta]:"fire-auth-compat",[wa]:"fire-rtdb",[Sa]:"fire-data-connect",[Ca]:"fire-rtdb-compat",[Aa]:"fire-fn",[Da]:"fire-fn-compat",[Oa]:"fire-iid",[Na]:"fire-iid-compat",[Pa]:"fire-fcm",[Ra]:"fire-fcm-compat",[xa]:"fire-perf",[La]:"fire-perf-compat",[Ma]:"fire-rc",[Ua]:"fire-rc-compat",[Va]:"fire-gcs",[Fa]:"fire-gcs-compat",[Ba]:"fire-fst",[ja]:"fire-fst-compat",[$a]:"fire-vertex","fire-js":"fire-js",[Ha]:"fire-js-all"};/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function go(t,e){return Se(t,"POST","/v1/accounts:delete",e)}async function Nr(t,e){return Se(t,"POST","/v1/accounts:lookup",e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function bo(t,e){const n=await Dr(t,{},async()=>{const s=Ve({grant_type:"refresh_token",refresh_token:e}).slice(1),{tokenApiHost:r,apiKey:i}=t.config,a=Or(t,r,"/v1/token",`key=${i}`),c=await t._getAdditionalHeaders();return c["Content-Type"]="application/x-www-form-urlencoded",Ar.fetch()(a,{method:"POST",headers:c,body:s})});return{accessToken:n.access_token,expiresIn:n.expires_in,refreshToken:n.refresh_token}}async function Eo(t,e){return Se(t,"POST","/v2/accounts:revokeToken",en(t,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let rn={async loadJS(){throw new Error("Unable to load external scripts")},recaptchaV2Script:"",recaptchaEnterpriseScript:"",gapiScript:""};function No(t){rn=t}function Po(t){return rn.loadJS(t)}function Ro(){return rn.gapiScript}function xo(t){return`__${t}${Math.floor(Math.random()*1e6)}`}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Te{constructor(e){this.user=e.user,this.providerId=e.providerId,this._tokenResponse=e._tokenResponse,this.operationType=e.operationType}static async _fromIdTokenResponse(e,n,s,r=!1){const i=await z._fromIdTokenResponse(e,s,r),a=On(s);return new Te({user:i,providerId:a,_tokenResponse:s,operationType:n})}static async _forOperation(e,n,s){await e._updateTokensIfNecessary(s,!0);const r=On(s);return new Te({user:e,providerId:r,_tokenResponse:s,operationType:n})}}function On(t){return t.providerId?t.providerId:"phoneNumber"in t?"phone":null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Oc=new Be(5e3,15e3),Nc="__/auth/iframe",Pc="emulator/auth/iframe",Rc={style:{position:"absolute",top:"-100px",width:"1px",height:"1px"},"aria-hidden":"true",tabindex:"-1"},xc=new Map([["identitytoolkit.googleapis.com","p"],["staging-identitytoolkit.sandbox.googleapis.com","s"],["test-identitytoolkit.sandbox.googleapis.com","t"]]);function Lc(t){const e=t.config;v(e.authDomain,t,"auth-domain-config-required");const n=e.emulator?Zt(e,Pc):`https://${t.config.authDomain}/${Nc}`,s={apiKey:e.apiKey,appName:t.name,v:Fe},r=xc.get(t.config.apiHost);r&&(s.eid=r);const i=t._getFrameworks();return i.length&&(s.fw=i.join(",")),`${n}?${Ve(s).slice(1)}`}async function Mc(t){const e=await Dc(t),n=B().gapi;return v(n,t,"internal-error"),e.open({where:document.body,url:Lc(t),messageHandlersFilter:n.iframes.CROSS_ORIGIN_IFRAMES_FILTER,attributes:Rc,dontclear:!0},s=>new Promise(async(r,i)=>{await s.restyle({setHideOnLeave:!1});const a=V(t,"network-request-failed"),c=B().setTimeout(()=>{i(a)},Oc.get());function o(){B().clearTimeout(c),r(s)}s.ping(o).then(o,()=>{i(a)})}))}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ot="webStorageSupport";class Kc{constructor(){this.eventManagers={},this.iframes={},this.originValidationPromises={},this._redirectPersistence=Xr,this._completeRedirectFn=vc,this._overrideRedirectResult=mc}async _openPopup(e,n,s,r){var i;Y((i=this.eventManagers[e._key()])===null||i===void 0?void 0:i.manager,"_initialize() not called before _openPopup()");const a=await Mn(e,n,s,Ht(),r);return jc(e,a,an())}async _openRedirect(e,n,s,r){await this._originValidation(e);const i=await Mn(e,n,s,Ht(),r);return Xo(i),new Promise(()=>{})}_initialize(e){const n=e._key();if(this.eventManagers[n]){const{manager:r,promise:i}=this.eventManagers[n];return r?Promise.resolve(r):(Y(i,"If manager is not set, promise should be"),i)}const s=this.initAndGetManager(e);return this.eventManagers[n]={promise:s},s.catch(()=>{delete this.eventManagers[n]}),s}async initAndGetManager(e){const n=await Mc(e),s=new Ic(e);return n.register("authEvent",r=>(v(r==null?void 0:r.authEvent,e,"invalid-auth-event"),{status:s.onEvent(r.authEvent)?"ACK":"ERROR"}),gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER),this.eventManagers[e._key()]={manager:s},this.iframes[e._key()]=n,s}_isIframeWebStorageSupported(e,n){this.iframes[e._key()].send(Ot,{type:Ot},r=>{var i;const a=(i=r==null?void 0:r[0])===null||i===void 0?void 0:i[Ot];a!==void 0&&n(!!a),j(e,"internal-error")},gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER)}_originValidation(e){const n=e._key();return this.originValidationPromises[n]||(this.originValidationPromises[n]=wc(e)),this.originValidationPromises[n]}get _shouldInitProactively(){return $r()||Lr()||nn()}}const Yc=Kc;var Un="@firebase/auth",Vn="1.8.1";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Zc=5*60,el=vr("authIdTokenMaxAge")||Zc;let Fn=null;const tl=t=>async e=>{const n=e&&await e.getIdTokenResult(),s=n&&(new Date().getTime()-Date.parse(n.issuedAtTime))/1e3;if(s&&s>el)return;const r=n==null?void 0:n.token;Fn!==r&&(Fn=r,await fetch(t,{method:r?"POST":"DELETE",headers:r?{Authorization:`Bearer ${r}`}:{}}))};function nl(t=Ya()){const e=br(t,"auth");if(e.isInitialized())return e.getImmediate();const n=Lo(t,{popupRedirectResolver:Yc,persistence:[ac,Yr,Xr]}),s=vr("authTokenSyncURL");if(s&&typeof isSecureContext=="boolean"&&isSecureContext){const i=new URL(s,location.origin);if(location.origin===i.origin){const a=tl(i.toString());Go(n,a,()=>a(n.currentUser)),zr(n,c=>a(c))}}const r=Li("auth");return r&&Uo(n,`http://${r}`),n}function rl(){var t,e;return(e=(t=document.getElementsByTagName("head"))===null||t===void 0?void 0:t[0])!==null&&e!==void 0?e:document}No({loadJS(t){return new Promise((e,n)=>{const s=document.createElement("script");s.setAttribute("src",t),s.onload=e,s.onerror=r=>{const i=V("internal-error");i.customData=r,n(i)},s.type="text/javascript",s.charset="UTF-8",rl().appendChild(s)})},gapiScript:"https://apis.google.com/js/api.js",recaptchaV2Script:"https://www.google.com/recaptcha/api.js",recaptchaEnterpriseScript:"https://www.google.com/recaptcha/enterprise.js?render="});Qc("Browser");var sl="firebase",il="11.1.0";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
