-- Create company_yearly_ratio table
CREATE TABLE "company_yearly_ratio" (
...
ALTER TABLE "public"."company_yearly_ratio" add constraint "company_yearly_ratio_co_code" unique ("co_code");
CREATE INDEX "idx_company_yearly_ratio_co_code" on "public"."company_yearly_ratio" using btree ("co_code");
