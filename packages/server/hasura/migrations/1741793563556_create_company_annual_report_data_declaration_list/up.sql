...
ALTER TABLE "public"."company_annual_report_data_declaration_list" add constraint "company_annual_report_data_declaration_list_reporttype_reportd" unique ("reporttype", "reportdate", "co_code");
