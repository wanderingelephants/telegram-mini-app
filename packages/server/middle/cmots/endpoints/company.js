...
const route = async (req, res) => {
    ...
    const standaloneConsolidated = req.params.standaloneConsolidated
    console.log("get company data", apiType, companyId, standaloneConsolidated)
    try {
        const apiUrl = standaloneConsolidated ? `${cmotsApiUrl}/${apiType}/${companyId}/${standaloneConsolidated}` : `${cmotsApiUrl}/${apiType}/${companyId}`
