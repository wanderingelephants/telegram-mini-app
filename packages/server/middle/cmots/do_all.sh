...
# node json_to_pgsql.js json/company_result_balance_sheet_asset_and_liabilities_half_yearly.json hasura_test hasura_mutations
# node json_to_pgsql.js json/company_result_balance_sheet_asset_and_liabilities_quarterly.json hasura_test hasura_mutations
# node json_to_pgsql.js json/company_result_balance_sheet_asset_and_liabilities_yearly.json hasura_test hasura_mutations
...
node  --env-file=../.env persist_data_for_tables_json.js json/company_index_master_only.json
