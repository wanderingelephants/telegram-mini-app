...
# node --env-file=../.env json_to_pgsql.js json/all_tables.json hasura_test hasura_mutations
...
#node --env-file=../.env persist_data_for_tables_json.js json/company_result_balance_sheet_half_yearly.json
# node --env-file=../.env persist_data_for_tables_json.js json/company_result_balance_sheet_quarterly.json
# node --env-file=../.env persist_data_for_tables_json.js json/company_result_balance_sheet_yearly.json
...
# node --env-file=../.env persist_data_for_tables_json.js json/company_yearly_reports.json
