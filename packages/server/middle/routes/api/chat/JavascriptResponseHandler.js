        ...
        try {
            switch (functionName) {
                ...
                case "analysis":
                    ...
                    result = await analysis(dbData.mutual_funds, dbData.mutual_fund_stock_holdings, dbData.holding_reporting_dates, dbData.insider_trades, dbData.corporate_announcements, dbData.daily_closing_stock_prices_by_company_name, dbData.market_nse_nifty_closing_prices, user_stock_portfolio, dbData.fifty_two_week_highs, dbData.fifty_two_week_lows)
                    break;
            }
